...
export function CardStyle1({
  ...
  return (
    <div
      className={cn(
        "relative text-[#2D2E2F] bg-gradient-to-b from-[#FFFDEE] to-[#F9F3B1] border border-[var(--custom-primary)] shadow-[4.17px_4.17px_12.5px_0px_rgba(0,0,0,0.25)] rounded-xl p-4 md:p-6 lg:p-8 xl:p-10 max-sm:min-h-44 flex flex-col justify-center items-center gap-2 text-center",
        className
      )}
    >
      <Image
