    ...
    <>
      ...
      >
        <div className="flex flex-col gap-4 lg:gap-6 text-sm max-lg:text-xs">
          ...
          <p>
            These Terms & Conditions apply to all driving tuition services
            offered by Cambridge Driving Academy Ltd. By booking and attending
            lessons, you agree to the following:
          </p>
          <div>
            ...
            <ul className="list-disc pl-5">
              ...
              <li>
                &quot;Student&quot; means the individual receiving tuition.
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="list-disc pl-5">
              ...
              <li>
                The contract for tuition is strictly between you (the student)
                and your instructor.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-5">
              ...
              <li>
                Refunds on block bookings are pro-rated and exclude any
                discounts.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-5">
              ...
              <li>
                Use of your personal vehicle is at the instructor’s discretion
                and requires insurance proof.
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="list-disc pl-5">
              <li>
                Students must confirm test readiness with their instructor
                before booking.
              </li>
              <li>
              ...
              <li>
                DVSA test fees do not cover instructor time or vehicle use.
              </li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="list-disc pl-5">
              <li>
                Instructors are liable only for foreseeable loss or damage
