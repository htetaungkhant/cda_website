...
export default async function ManualIntensiveDrivingClass() {
  ...
  return (
    <>
      ...
      {intensiveManualCourses && intensiveManualCourses.length > 0 ? (
        <CoursesGrid
        ...
        <p className="text-center text-sm text-gray-500 my-8">
          No manual intensive driving courses available at the moment.
        </p>
      )}
